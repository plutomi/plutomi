...
export const orgInviteSchema = new Schema<IOrgInvite>({
  ...baseSchema.obj,
  org: { type: Schema.Types.ObjectId, default: DEFAULTS.FIRST_NAME, ref: Org },
  createdBy: { type: Schema.Types.ObjectId, default: DEFAULTS.FIRST_NAME, ref: User },
  recipient: { type: Schema.Types.ObjectId, default: DEFAULTS.FIRST_NAME, ref: User },
