...
// Default: 1 day
const COOKIE_DURATION = 5000;

// Temporary cookie password - must be > 32 char in length
const COOKIE_PASSWORD =
  "BEANS BEANS BEANSE BEANS BEANS BEANSE BEANS BEANS BEANSE BEANS BEANS BEANSE BEANS BEANS BEANSE BEANS BEANS BEANSE BEANS BEANS BEANSE BEANS BEANS BEANSE BEANS BEANS BEANSE BEANS BEANS BEANSE BEANS BEANS BEANSE BEANS BEANS BEANSE ";
export {
