    ...
    const getVariantClasses = () => {
      if (variant === "secondary-outline") {
        const defaultClasses =
          "bg-white border text-slate-700 border-slate-400 drop-shadow";
      ...
      if (variant === "danger") {
        const defaultClasses = "bg-red-500 text-white drop-shadow";
        const onlyWhenEnabledClasses =
      ...
      // Default - Primary
      const defaultClasses = "text-white bg-blue-500 drop-shadow";
      const onlyWhenEnabledClasses =
