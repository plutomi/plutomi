...
export default async function sendLoginLink({
  ...
  const new_email: SendEmailCommandInput = {
    ...
    Message: {
      ...
      Body: {
        Html: {
          Data: `<h1><a href="${loginLink}" noreferrer target="_blank" >Click this link to log in</a></h1><p>It will expire ${login_link_relative_expiry}. <strong>DO NOT SHARE THIS LINK WITH ANYONE!!!</strong></p><p>If you did not request this link, you can safely ignore it.</p>`,
        },
      },
    },
  };
