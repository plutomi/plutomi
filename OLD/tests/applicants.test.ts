...
import * as Orgs from '../.vscode/adapters/Orgs';
import * as Openings from '../.vscode/adapters/Openings';
import * as Stages from '../.vscode/adapters/Stages';
import * as Applicants from '../.vscode/adapters/Applicants';
