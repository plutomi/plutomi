...
import { combineClassNames, findInTargetArray } from '../../OLD/utils';
...
export const OpeningsDropdown = ({ openings, index }: OpeningsDropdownProps) => {
  ...
  const handleChange = (newValue: OpeningEntity) => {
                ...
                >
                  {({ selected, active }) => {
                    ...
                    const currentOpeningState = findInTargetArray(
                      IndexableProperties.OpeningState,
                      currentOpening,
                    );
                    return (
                      <>
                        <div className="flex items-center">
                          ...
                          >
                            ...
                            <span className="sr-only">
                              {' '}
                              is{' '}
                              {currentOpeningState === OpeningState.Public ? 'online' : 'offline'}
                            </span>
                          </span>
                        </div>
