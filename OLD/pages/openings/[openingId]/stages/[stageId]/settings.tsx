...
import { GetOpeningInfoURL } from '../../../../../OLD/.vscode/adapters/Openings';
import { GetStagesInOpeningURL, DeleteStage } from '../../../../../OLD/.vscode/adapters/Stages';
...
export default function StageSettings() {
  ...
  return (
    <NewPageLayout
      ...
      headerText={
        isStageLoading ? 'Loading settings...' : `${opening?.name} > ${stage?.name} - Settings`
      }
    >
      <>
