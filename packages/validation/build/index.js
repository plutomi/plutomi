...
__export(exports_schemas, {
  ...
  LogInOrSignUp: () => {
    {
      return exports_logInOrSignUp;
    }
  }
});

// packages/validation/src/schemas/subscribe/index.ts
...
// packages/validation/src/schemas/utils/trimAndLowercase/trimAndLowerCase.ts
var trimAndLowerCase = (u) => typeof u === "string" ? u.trim().toLocaleLowerCase() : u;
// packages/validation/src/schemas/utils/trim/trim.ts
var trim = (u) => typeof u === "string" ? u.trim() : u;
// packages/validation/src/schemas/shared/emailSchema.ts
var emailSchema = z.preprocess(trimAndLowerCase, z.string({
  required_error: "Email is required"
}).email("That email doesn't look right..."));
// packages/validation/src/schemas/subscribe/subscribe.ts
var baseSchema = z.object({
  email: emailSchema
});
var UISchema = baseSchema;
var APISchema = baseSchema;
// packages/validation/src/schemas/logInOrSignUp/index.ts
var exports_logInOrSignUp = {};
__export(exports_logInOrSignUp, {
  validateEmailAndTotp: () => {
    {
      return exports_validateEmailAndTotp;
    }
  },
  totp: () => {
    {
  ...
  email: () => {
    {
      return exports_email;
    }
  }
});

// packages/validation/src/schemas/logInOrSignUp/totp.ts
var exports_totp = {};
__export(exports_totp, {
  baseSchema: () => {
    {
      return baseSchema2;
    }
...
// packages/shared/src/consts/totp.ts
var TOTP_LENGTH = 6;
...
// packages/validation/src/schemas/logInOrSignUp/totp.ts
var baseSchema2 = z.object({
  totpCode: z.string({
    required_error: "Code is required"
  }).length(TOTP_LENGTH, `Code must be ${TOTP_LENGTH} characters`)
});
var UISchema2 = baseSchema2;
var APISchema2 = baseSchema2;
// packages/validation/src/schemas/logInOrSignUp/email.ts
var exports_email = {};
...
var baseSchema3 = z.object({
  email: emailSchema
});
var UISchema3 = baseSchema3;
var APISchema3 = baseSchema3;
// packages/validation/src/schemas/logInOrSignUp/validateEmailAndTotp.ts
var exports_validateEmailAndTotp = {};
__export(exports_validateEmailAndTotp, {
  APISchema: () => {
    {
      return APISchema4;
    }
...
var baseSchema4 = baseSchema3.merge(baseSchema2);
var APISchema4 = baseSchema4;
// packages/validation/src/schemas/orgs/index.ts
var exports_orgs = {};
...
// packages/validation/src/schemas/orgs/post/post.ts
var exports_post = {};
__export(exports_post, {
  UIWorkspaceIdStepSchema: () => {
    {
      return UIWorkspaceIdStepSchema;
    }
  },
  UISchema: () => {
    {
...
// packages/validation/src/consts/reservedWorkspaceIds.ts
var reservedWorkspaceIds = [
  "plutomi",
  "plutomiinc",
  "plutomi-inc",
  "login",
...
// packages/validation/src/schemas/orgs/post/post.ts
var baseSchema5 = z.object({
  name: z.preprocess(trim, z.string({
    required_error: "Organization name is required.",
    invalid_type_error: "Organization name must be a string."
  }).trim().min(1, "Organization name must be at least 1 character long.").max(100, "Organization name must be at most 100 characters long.")),
  custom_workspace_id: z.preprocess(trimAndLowerCase, z.string({
    required_error: "Workspace ID is required.",
    invalid_type_error: "Workspace ID must be a string."
  }).regex(/^[a-z0-9-]*$/, "Workspace ID must only contain lowercase letters, numbers, and dashes.").min(1, "Workspace ID must be at least 1 character long.").max(25, "Workspace ID must be at most 25 characters long.").refine((value) => reservedWorkspaceIds.every((id) => id !== value), (value) => ({
    message: `'${value}' cannot be used as a workspace ID.`
  })))
});
var UIOrgStepSchema = baseSchema5.pick({ name: true });
var UIWorkspaceIdStepSchema = baseSchema5.pick({
  custom_workspace_id: true
});
var UISchema4 = baseSchema5;
var APISchema5 = baseSchema5;
