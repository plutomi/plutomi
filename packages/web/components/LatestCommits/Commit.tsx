...
export const Commit: React.FC<CommitType> = ({
  ...
  return (
      ...
      <div className="group p-2 bg-white w-full max-w-3xl rounded-md shadow-md hover:shadow-lg transition ease-in-out duration-150 hover:scale-102 cursor-pointer" onClick={handleCardClick}>
