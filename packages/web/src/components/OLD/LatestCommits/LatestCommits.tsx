...
export default async function LatestCommits() {
    ...
    return (
      <div className="bg-white shadow rounded-lg">
        <div className=" max-w-7xl px-6 py-8 sm:py-8   flex flex-col md:flex-row justify-center items-center  ">
          <h2 className="text-xl font-bold tracking-tight text-slate-900 sm:text-2xl   align-baseline">
            We had some trouble loading the latest changes :(
          </h2>
  ...
  return commits.map((commit) => <Commit {...commit} key={commit.message} />);
}
