          ...
          {webhooks.map((webhook) => (
            <li key={webhook.id}>
              <Link href="##" passHref>
                ...
                <a className=" hover:bg-gray-50 flex justify-between items-center">
                  <div className="px-4 py-4 sm:px-6 w-1/2">
                    <div className="flex items-center justify-between">
                      <p className="text-lg font-medium text-dark truncate">{webhook.name}</p>
                    </div>
                    <div className="mt-2 sm:flex sm:justify-between">
                      <div className="sm:flex">
                        <p className="flex items-center text-sm text-gray-500">{webhook.url}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    <ChevronRightIcon className="h-6 w-6 text-gray-400 ml-2" aria-hidden="true" />
                  </div>
                </a>
              </Link>
            </li>
