...
import { DynamoOrgLoginEvent } from '../../types/dynamo';
...
export const createLoginEvent = async (props: CreateLoginEventAndDeleteLoginLinkInput) => {
  return true; // TODO
  // const { loginLinkId, user } = props;

  // const now = Time.currentISO();

  // const newUserLoginEvent: IUserLoginEvent = {
