...
export const updateStage = async (props: UpdateStageInput): Promise<[null, null] | [null, any]> => {
  ...
  const endedInTheMiddle = !endedAtTheBeginning && !endedAtTheEnd;
  ...
  /**
   * Scenario 11
   * Starting in the middle, moved one stage down (swap), not at the end
   *
   *     OLD --- NEW
   * Stage 1 --- Stage 1
   * Stage 2 --- Stage 3
  ...
  /**
   * Scenario 12
   * Starting in the middle, moved one stage up (swap), not at the start
   *
   *     OLD --- NEW
   * Stage 1 --- Stage 1
   * Stage 2 --- Stage 3 <-- Moved
  ...
  /**
   * Scenario 15
   * Starting in the middle, moved multiple stages up, end at the middle
   *
   *     OLD --- NEW
   * Stage 1 --- Stage 1
   * Stage 2 --- Stage 4 <-- Moved up
   * Stage 3 --- Stage 2
   * Stage 4 --- Stage 3
   * Stage 5 --- Stage 5
   */
