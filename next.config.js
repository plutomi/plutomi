module.exports = {
  ...
  env: {
    NEXT_PUBLIC_WEBSITE_URL: process.env.WEBSITE_URL || `http://localhost:3000`, // URL of your website: https://plutomi.com
    NEXT_PUBLIC_API_URL: process.env.API_URL || `http://localhost:4000`, // URL of your API: https://api.plutomi.com
